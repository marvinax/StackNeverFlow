...
/***/ function(module, exports, __webpack_require__) {
	...
	var NoteHolder = React.createClass({displayName: "NoteHolder",
		...
		render : function() {
			...
			return(
				React.createElement("div", {className: "note-holder"}, 
					renderedEntries
				)
			)
		}
	...
	React.render(React.createElement(NoteHolder, null), document.getElementById('content'));
