...
/***/ function(module, exports, __webpack_require__) {
	...
	var Notette = __webpack_require__(157);
	var EntryModel = __webpack_require__(160);
	...
	function render(){
		React.render(React.createElement(Entry, null), document.getElementById('content'));
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Textarea = __webpack_require__(158);
	...
	var Notette = React.createClass({displayName: "Notette",
	    componentDidMount : function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	Utils = {
		...
		getStoreLength: function(namespace) {
			var store = localStorage.getItem(namespace);
			console.log(store);
			return store ? JSON.parse(store).length : 0;
		},
